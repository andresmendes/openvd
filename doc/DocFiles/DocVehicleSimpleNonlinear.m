...
%
% The code of this class can be found in <api/VehicleSimpleNonlinear.html VehicleSimpleNonlinear>. It inherits methods from abstract class <api/VehicleSimple.html VehicleSimple>. The complete list of class codes is in <api/api.html API>.
%
%% Theory
...
%% See Also
%
% [<../index.html Home>] [<DocVehicleSimpleLinear.html Vehicle Simple Linear>] [<DocVehicleSimpleNonlinear4DOF.html Vehicle Simple Nonlinear 4DOF>]
%
