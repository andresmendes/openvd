...
# -*- coding: utf-8 -*-
#
# openvd documentation build configuration file, created by
# sphinx-quickstart on Sat Sep 23 12:30:40 2017.
#
...
author = 'Andre de S. Mendes & Douglas de Rizzo Meneghetti'
...
html_theme_options = { "roottarget": "index","max_width":"15in"}
...
latex_documents = [
    (master_doc, 'openvd.tex', 'openvd Documentation',
     'ASM', 'manual'),
]
...
man_pages = [
    (master_doc, 'openvd', 'openvd Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'openvd', 'openvd Documentation',
     author, 'openvd', 'One line description of project.',
     'Miscellaneous'),
]
