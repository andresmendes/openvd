function [sys,x0,str,ts] = VehicleSystem(t,x,u,flag)
% This file is a s-function template for simulating the vehicle models in Simulink.
...
%% See Also
%
% <../index.html index> | <SimulinkApplication.html Simulink Application>
%
